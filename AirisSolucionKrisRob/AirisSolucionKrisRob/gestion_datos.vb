...
Public Class gestion_datos
    ...
    Private Sub tslbl_nuevo_Click(sender As Object, e As EventArgs)
        tb_emple_id.Text = ""
        tb_emple_rol.Text = ""
        tb_emple_usu.Text = ""
        tb_emple_cont.Text = ""
    ...
    Private Sub tslbl_baja_empleados_Click(sender As Object, e As EventArgs)
    ...
    Private Sub tslbl_alta_empleados_Click(sender As Object, e As EventArgs)
    ...
    Private Sub tslbl_modificar_empleados_Click(sender As Object, e As EventArgs)
